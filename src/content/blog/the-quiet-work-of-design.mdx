...
import img2 from "../../assets/blog/quiet_work2.jpg";
import img3 from "../../assets/blog/quiet_work3.jpg";
...
<BlogGallery 
  images={[
    { src: img2, alt: "Understated flooring pathways guiding movement along museum gallery corridors." },
    { src: img3, alt: "Close up tracking shot of custom premium stone layout borders and textural finishes." }
  ]} 
  cols={2} 
/>
